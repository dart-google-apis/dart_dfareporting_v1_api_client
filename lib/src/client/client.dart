...
abstract class Client extends ClientBase {
  core.String basePath = "/dfareporting/v1/";
  ...
  DimensionValuesResource_ get dimensionValues => new DimensionValuesResource_(this);
  FilesResource_ get files => new FilesResource_(this);
  ReportsResource_ get reports => new ReportsResource_(this);
  UserProfilesResource_ get userProfiles => new UserProfilesResource_(this);
